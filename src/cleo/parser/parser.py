...
from cleo.parser.actions import _AppendAction
from cleo.parser.actions import _AppendConstAction
from cleo.parser.actions import _CountAction
from cleo.parser.actions import _ExtendAction
from cleo.parser.actions import _HelpAction
from cleo.parser.actions import _StoreAction
from cleo.parser.actions import _StoreConstAction
from cleo.parser.actions import _StoreFalseAction
from cleo.parser.actions import _StoreTrueAction
from cleo.parser.actions import _SubParsersAction
from cleo.parser.actions import _VersionAction
...
class _ActionsContainer:
    ...
    def add_argument(self, *args, **kwargs):
        ...
        if hasattr(self, "_get_formatter"):
            try:
                ...
                raise ValueError("length of metavar tuple does not match nargs") from e
    ...
    def _get_positional_kwargs(self, dest: str, **kwargs: Any) -> dict[str, Any]:
        ...
        # always required
        if (
            kwargs.get("nargs") not in [NArgsEnum.OPTIONAL, NArgsEnum.ZERO_OR_MORE]
        ) or (
            kwargs.get("nargs") == NArgsEnum.ZERO_OR_MORE and "default" not in kwargs
        ):
...
class ArgumentParser(_AttributeHolder, _ActionsContainer):
    ...
    def _get_value(self, action, arg_string):
        ...
        # ArgumentTypeErrors indicate errors
            ...
            msg = str(err)
            raise ArgumentError(action, msg) from err
